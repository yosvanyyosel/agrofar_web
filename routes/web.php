...
use App\Http\Controllers\{
    AnalistaController,
    AreaController, GestorInsumosController, GestorPersonalController, TrabajadorController, LaborController, HabilidadesTrabajadorController,
...
Route::middleware(['auth', 'role:analista_user,admin_user'])->group(function () {
    ...
    Route::get('/analista', [AnalistaController::class, 'index'])->name('analista.dashboard');
...
Route::middleware(['auth', 'role:insumos_user,admin_user'])->group(function () {
    Route::get('/insumos', [GestorInsumosController::class, 'index'])->name('insumos.dashboard');
...
Route::middleware(['auth', 'role:personal_user,admin_user'])->group(function () {
    Route::get('/personal', [GestorPersonalController::class, 'index'])->name('personal.dashboard');

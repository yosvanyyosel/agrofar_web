<x-app-layout>
    <div class="max-w-lg mx-auto mt-10 bg-white dark:bg-neutral-900 rounded-xl shadow p-8">
        <h2 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">Nueva Habilidad</h2>
        <form method="POST" action="{{ route('habilidades-trabajadores.store') }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="tipo_labor" class="form-input w-full rounded-lg" required value="{{ old('tipo_labor') }}">

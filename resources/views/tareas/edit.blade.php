<x-app-layout>
    <div class="max-w-lg mx-auto mt-10 bg-white dark:bg-neutral-900 rounded-xl shadow p-8">
        <h2 class="text-2xl font-bold mb-6 text-blue-700 dark:text-blue-400">Editar Tarea</h2>
        <form method="POST" action="{{ route('tareas.update', $tarea->id_tarea) }}" class="space-y-5">
            @csrf
            @method('PUT')
            <div>
                <label class="block font-semibold mb-1">ID Trabajador</label>
                <input type="text" name="id_trabajador" class="form-input w-full rounded-lg" required value="{{ old('id_trabajador', $tarea->id_trabajador) }}">
            ...
            <div>
                ...
                <input type="text" name="id_labor" class="form-input w-full rounded-lg" required value="{{ old('id_labor', $tarea->id_labor) }}">
            ...
            <div>
                ...
                <input type="text" name="id_produccion" class="form-input w-full rounded-lg" required value="{{ old('id_produccion', $tarea->id_produccion) }}">
            ...
            <div>
                ...
                <input type="date" name="fecha_inicio" class="form-input w-full rounded-lg" required value="{{ old('fecha_inicio', $tarea->fecha_inicio) }}">
            ...
            <div>
                ...
                <input type="date" name="fecha_fin" class="form-input w-full rounded-lg" required value="{{ old('fecha_fin', $tarea->fecha_fin) }}">
